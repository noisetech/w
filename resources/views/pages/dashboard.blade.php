                            ...
                            <li class="mb-2">
                                <a class="dropdown-item border-radius-md" href="javascript:;">
                                    <div class="d-flex py-1">
                                        <div class="my-auto">
                                            <img src="{{ asset('backend/assets/img/small-logos/logo-spotify.svg') }}"
                        ...
                        <div class="row">
                            ...
                            <div class="col-lg-5 ms-auto text-center mt-5 mt-lg-0">
                                <div class="bg-gradient-primary border-radius-lg h-100">
                                    <img src="{{ asset('backend//assets/img/shapes/waves-white.svg') }}"
                                        class="position-absolute h-100 w-50 top-0 d-lg-block d-none" alt="waves">
                                    <div class="position-relative d-flex align-items-center justify-content-center h-100">
                                        <img class="w-100 position-relative z-index-2 pt-4"
                                            src="{{ asset('backend/assets/img/illustrations/rocket-white.png') }}"
                                            alt="rocket">
                                    </div>
                                </div>
                            </div>
            ...
            <div class="col-lg-5">
                <div class="card h-100 p-3">
                    <div class="overflow-hidden position-relative border-radius-lg bg-cover h-100"
                        style="background-image: url('{{ asset('backend/assets/img/ivancik.jpg') }}');">
                                ...
                                <tbody>
                                    <tr>
                                        <td>
                                            <div class="d-flex px-2 py-1">
                                                <div>
                                                    <img src="{{ asset('backend/assets/img/small-logos/logo-xd.svg') }}"
                                        ...
                                        <td>
                                            <div class="avatar-group mt-2">
                                                <a href="javascript:;" class="avatar avatar-xs rounded-circle"
                                                    ...
                                                    title="Ryan Tompson">
                                                    <img src="{{ asset('backend/assets/img/team-1.jpg') }}"
                                                        alt="team1">
                                                </a>
                                                <a href="javascript:;" class="avatar avatar-xs rounded-circle"
                                                    data-bs-toggle="tooltip" data-bs-placement="bottom"
                                    ...
                                    <tr>
                                        <td>
                                            <div class="d-flex px-2 py-1">
                                                <div>
                                                    <img src="{{ asset('backend/assets/img/small-logos/logo-atlassian.svg') }}"
                                    ...
                                    <tr>
                                        <td>
                                            <div class="d-flex px-2 py-1">
                                                <div>
                                                    <img src="{{ asset('backend/assets/img/small-logos/logo-slack.svg') }}"
                                    ...
                                    <tr>
                                        <td>
                                            <div class="d-flex px-2 py-1">
                                                <div>
                                                    <img src="{{ asset('backend//assets/img/small-logos/logo-jira.svg') }}"
                                    ...
                                    <tr>
                                        <td>
                                            <div class="d-flex px-2 py-1">
                                                <div>
                                                    <img src="{{ asset('backend/assets/img/small-logos/logo-invision.svg') }}"
