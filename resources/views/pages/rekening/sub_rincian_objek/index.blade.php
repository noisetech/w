...
@section('title', 'Sub Rincian Objek Rekening')
@section('content')
    {{ navbar('Sub Rincian Objek Rekening', 'List Sub Rincian Objek Rekening') }}
            ...
            <div class="col-lg-3 col-md-3 col-sm-12 h-100">
                <div class="card">
                    <div class="card-body p-3">
                        ...
                        <div class="alert alert-dark">
                            <strong
                                class="text-white">Rincian
                                Objek Rekening</strong>
                        </div>
                        <div class="alert alert-dark">
                            <strong
                                class="text-white">Sub
            ...
            <div class="col-lg-9 col-md-9 col-sm-12">
                <div class="card h-100">
                    <div class="card-header pb-0">
                        ...
                        <h6>Sub Rincian Objek Rekening</h6>
                    </div>
                    <div class="card-body">
                                ...
                                <div class="row">
                                    <div class="col-sm-1">
                                        <div class="form-group">
                                            <input type="hidden" class="form-control" name="rincian_objek_rekening_id"
                                                value="{{ $rincian_objek->id }}">
                                        </div>
                                    </div>
                                </div>
...
<script>
        $("#form_create").submit(function(e) {
            ...
            $.ajax({
                url: '{{ route('rekening.p_tambah_sub_rincian_objek_rekening') }}',
                method: 'post',
                data: fd,
                cache: false,
                processData: false,
        ...
        $(document).on('submit', '#form_edit', function(e) {
            ...
            const fd = new FormData(this);
            $.ajax({
                url: '{{ route('rekening.p_edit_sub_rincian_objek_rekening') }}',
                method: 'post',
                data: fd,
                cache: false,
                processData: false,
    ...
    <script>
        $('#dataTable').DataTable({
            ...
            order: [],
            ajax: {
                url: "{{ route('rekening.data_sub_rincian_objek_rekening') }}",
                data: {
                    id: "{{ encrypsi($segment) }}"
                },
            },
    ...
    <script>
        ...
        function edit(data) {
            ...
            $.ajax({
                url: '{{ route('rekening.edit_sub_rincian_objek_rekening') }}',
                method: 'get',
                data: {
                    id: id,
                    _token: '{{ csrf_token() }}'
        ...
        function hapus(data) {
            ...
            Swal.fire({
                ...
                if (result.value) {
                    $.ajax({
                        type: "POST",
                        url: "{{ route('rekening.hapus_sub_rincian_objek_rekening') }}",
                        data: {
                            id: id,
                            _token: "{{ csrf_token() }}"
                        },
