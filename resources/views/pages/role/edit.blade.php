                ...
                <div class="card shadow">
                    ...
                    <div class="card-body">
                        <form action="#" method="POST" id="role_form">
                            ...
                            <input type="hidden" name="id" class="form-control" id="id_role"
                                value="{{ $role->id }}">
                            ...
                            <div class="form-group">
                                ...
                                <select class="permission form-control" name="permissions[]" multiple="multiple">

                                </select>
                            </div>

                            <button class="btn mt-5 btn-sm btn-success" type="submit" id="role_btn">
                                Simpan
                            </button>
                        </form>
                    </div>
...
@push('script')
    ...
    <script>
        ...
        $.ajax({
            type: 'GET',
            url: "{{ route('role.permissionByRole') }}",
            data: {
                id: role_id
            }
        }).then(function(data) {
