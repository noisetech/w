...
@push('script')
    ...
    <script>
        $("#form_urusan_bidang").submit(function(e) {
            ...
            $.ajax({
                url: '{{ route('perencanaan.p_form_urusan_bidang') }}',
                method: 'post',
                data: fd,
                cache: false,
                processData: false,
        ...
        function hapusDataBidang(data) {
            ...
            Swal.fire({
                ...
                if (result.value) {
                    $.ajax({
                        type: "POST",
                        url: "{{ route('perencanaan.hapusBidangPerencanaan') }}",
                        data: {
                            id: id,
                            _token: "{{ csrf_token() }}"
                        },
        ...
        function formEditBidangById(data) {
            ...
            $.ajax({
                url: '{{ route('perencanaan.formEditBidangById') }}',
                method: 'get',
                data: {
                    id: id,
                    _token: '{{ csrf_token() }}'
        ...
        $(document).on('submit', '#form_edit_bidang', function(e) {
            ...
            const fd = new FormData(this);
            $.ajax({
                url: '{{ route('perencanaan.p_formEditBidangById') }}',
                method: 'post',
                data: fd,
                cache: false,
                processData: false,
